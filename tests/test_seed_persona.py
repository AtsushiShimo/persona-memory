...
def test_seed_inserts_all_boot_facts(db_path: Path):
    """boot 層 = persona 12 + rule 2 = 14 件 seed される。"""
    ...
    # persona: 7 基本 + 5 default 行動指針 = 12
    assert len(persona_rows) == 12
    for k in (
        ...
        "natural_voice", "health_check_trigger",
    ):
